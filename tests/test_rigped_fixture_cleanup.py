...
GOLDEN_PATH = ROOT / "baselines" / "golden" / "rigped_animate_manual_baseline_v4.blend"
MANIFEST_PATH = ROOT / "baselines" / "golden" / "rigped_animate_manual_baseline_v4.json"
...
def test_golden_manual_baseline_hash_matches_manifest() -> None:
    ...
    assert expected == "f1bd6b2c7d4888f7f67f2ad7509ce842c095a8f14fd9015ebfb4f209d18035d8"
...
def test_manual_baseline_prepare_copies_golden_then_opens_working_copy() -> None:
    ...
    assert "root / 'baselines' / 'golden' / 'rigped_animate_manual_baseline_v4.blend'" in prepare
