...
DEFAULT_HUMANOID_BONES: tuple[HumanoidBoneSpec, ...] = (
    ...
    _bone("COM", "COM", "awb.com", "CENTER", "NEUTRAL", "PRIMARY", HumanoidLayer.AUTHORED, "ROOT", False, False, (0.0, 0.0, 0.95), (0.0, 0.0, 1.08)),
...
DEFAULT_HUMANOID_GROUPS: tuple[HumanoidGroupSpec, ...] = (
    ...
    HumanoidGroupSpec("awb.arm", "Left Arm", ("CLAVICLE.L", "UPPER_ARM.L", "FOREARM.L", "HAND.L", "IK_HAND.L", "POLE_ELBOW.L"), "LEFT"),
    HumanoidGroupSpec("awb.arm", "Right Arm", ("CLAVICLE.R", "UPPER_ARM.R", "FOREARM.R", "HAND.R", "IK_HAND.R", "POLE_ELBOW.R"), "RIGHT"),
    ...
    HumanoidGroupSpec("awb.hand", "Left Hand Terminal Orientation", ("HAND.L", "IK_HAND.L"), "LEFT"),
    HumanoidGroupSpec("awb.hand", "Right Hand Terminal Orientation", ("HAND.R", "IK_HAND.R"), "RIGHT"),
