...
class RawFieldKind(StrEnum):
    ...
    POSE_BONE_LOCK_IK_X = "POSE_BONE_LOCK_IK_X"
    POSE_BONE_LOCK_IK_Y = "POSE_BONE_LOCK_IK_Y"
    POSE_BONE_LOCK_IK_Z = "POSE_BONE_LOCK_IK_Z"
    POSE_BONE_USE_IK_LIMIT_X = "POSE_BONE_USE_IK_LIMIT_X"
    POSE_BONE_USE_IK_LIMIT_Y = "POSE_BONE_USE_IK_LIMIT_Y"
    POSE_BONE_USE_IK_LIMIT_Z = "POSE_BONE_USE_IK_LIMIT_Z"
    POSE_BONE_IK_MIN_X = "POSE_BONE_IK_MIN_X"
    POSE_BONE_IK_MAX_X = "POSE_BONE_IK_MAX_X"
    POSE_BONE_IK_MIN_Y = "POSE_BONE_IK_MIN_Y"
    POSE_BONE_IK_MAX_Y = "POSE_BONE_IK_MAX_Y"
    POSE_BONE_IK_MIN_Z = "POSE_BONE_IK_MIN_Z"
    POSE_BONE_IK_MAX_Z = "POSE_BONE_IK_MAX_Z"
